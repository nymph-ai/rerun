    ...
    let array = [
        ...
        (
            ...
            ComponentReflection {
                ...
                deprecation_summary: None,
                custom_placeholder: Some(AudioSampleRate::default().to_arrow()?),
                datatype: AudioSampleRate::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: AudioSampleRate::verify_arrow_array,
            },
        ),
        (
            <AudioSeekable as Component>::name(),
            ComponentReflection {
                docstring_md: "Marks a chunk as an independent seek target.\n\nA seekable chunk can be handed to the decoder without replaying any\nearlier chunk. Default is true for codecs whose segments are always\nself-contained (e.g. Opus); codecs with inter-frame dependencies should\nset this false on non-key segments.\n\n⚠\u{fe0f} **This type is _unstable_ and may change significantly in a way that the data won't be backwards compatible.**",
                deprecation_summary: None,
                custom_placeholder: Some(AudioSeekable::default().to_arrow()?),
                datatype: AudioSeekable::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: AudioSeekable::verify_arrow_array,
            },
        ),
        (
            <AudioSequenceNumber as Component>::name(),
            ComponentReflection {
                docstring_md: "Monotonic per-stream sequence number for a chunk.\n\nUseful for gap detection: a jump greater than 1 between successive rows\n(within the same [`components.AudioStreamId`](https://rerun.io/docs/reference/types/components/audio_stream_id?speculative-link)) surfaces a missing segment\nto the viewer without requiring payload inspection.\n\n⚠\u{fe0f} **This type is _unstable_ and may change significantly in a way that the data won't be backwards compatible.**",
                deprecation_summary: None,
                custom_placeholder: Some(AudioSequenceNumber::default().to_arrow()?),
                datatype: AudioSequenceNumber::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: AudioSequenceNumber::verify_arrow_array,
            },
        ),
        (
            <AudioSourceId as Component>::name(),
            ComponentReflection {
                docstring_md: "Stable identity for an audio source across streams, assets, summaries, and annotations.\n\nThis is intentionally independent from entity path: an entity path names where\ndata was logged, while an audio source id names the logical recording, device,\ntrack, or pipeline output that downstream derived data refers to.\n\n⚠\u{fe0f} **This type is _unstable_ and may change significantly in a way that the data won't be backwards compatible.**",
                deprecation_summary: None,
                custom_placeholder: Some(AudioSourceId::default().to_arrow()?),
                datatype: AudioSourceId::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: AudioSourceId::verify_arrow_array,
            },
        ),
        (
            <AudioStreamId as Component>::name(),
            ComponentReflection {
                docstring_md: "Stream continuity marker.\n\nRows that share a `stream_id` are considered parts of the same logical\ncapture; a change in `stream_id` signals a recorder restart or resync and\nis treated as an implicit discontinuity.\n\n⚠\u{fe0f} **This type is _unstable_ and may change significantly in a way that the data won't be backwards compatible.**",
                deprecation_summary: None,
                custom_placeholder: Some(AudioStreamId::default().to_arrow()?),
                datatype: AudioStreamId::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: AudioStreamId::verify_arrow_array,
            },
        ),
        (
            <AudioTimestamp as Component>::name(),
            ComponentReflection {
                docstring_md: "Timestamp inside an [`archetypes.AssetAudio`](https://rerun.io/docs/reference/types/archetypes/asset_audio?speculative-link).\n\n⚠\u{fe0f} **This type is _unstable_ and may change significantly in a way that the data won't be backwards compatible.**",
                deprecation_summary: None,
                custom_placeholder: Some(AudioTimestamp::default().to_arrow()?),
                datatype: AudioTimestamp::arrow_datatype(),
                is_enum: false,
                verify_arrow_array: AudioTimestamp::verify_arrow_array,
            },
        ),
        (
...
fn generate_archetype_reflection() -> ArchetypeReflectionMap {
    ...
    let array = [
            ...
            ArchetypeReflection {
                ...
                fields: vec![
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Blob",
                        component_type: "rerun.components.Blob".into(),
                        docstring_md: "The raw bytes of the audio asset.",
                        flags: ArchetypeFieldFlags::REQUIRED,
                    },
                    ArchetypeFieldReflection {
                        name: "media_type",
        ...
        (
            ArchetypeName::new("rerun.archetypes.AudioAnnotationSpan"),
            ArchetypeReflection {
                display_name: "Audio annotation span",
                deprecation_summary: None,
                scope: None,
                view_types: &["AudioView"],
                fields: vec![
                    ArchetypeFieldReflection {
                        ...
                        component_type: "rerun.components.AudioTimestamp".into(),
                        docstring_md: "Media-time start of each span, in nanoseconds.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "end_time",
                        ...
                        component_type: "rerun.components.AudioTimestamp".into(),
                        docstring_md: "Media-time end of each span, in nanoseconds.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "kind",
                        display_name: "Kind",
                        component_type: "rerun.components.AudioAnnotationKind".into(),
                        docstring_md: "Semantic class of each span.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "labels",
                        display_name: "Labels",
                        component_type: "rerun.components.Text".into(),
                        docstring_md: "Human-readable text for each span.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "confidence",
                        ...
                        docstring_md: "Confidence score per span. Convention: 0 is lowest confidence, 1 is highest.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "speaker",
                        ...
                        component_type: "rerun.components.Text".into(),
                        docstring_md: "Speaker identity or diarization label per span.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "source_id",
                        display_name: "Source id",
                        component_type: "rerun.components.AudioSourceId".into(),
                        docstring_md: "Stable identity of the audio source these spans refer to.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        ...
                        docstring_md: "Entity carrying the source [`archetypes.AudioStream`](https://rerun.io/docs/reference/types/archetypes/audio_stream?speculative-link) or [`archetypes.AssetAudio`](https://rerun.io/docs/reference/types/archetypes/asset_audio?speculative-link).",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "related",
                        ...
                        component_type: "rerun.components.EntityPath".into(),
                        docstring_md: "Optional related or parent entities, e.g. words belonging to an utterance.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "metadata",
                        ...
                        docstring_md: "Additional span metadata shared by this row.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "colors",
                        display_name: "Colors",
                        component_type: "rerun.components.Color".into(),
                        docstring_md: "Optional display color per span.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                ],
            },
        ...
        (
            ArchetypeName::new("rerun.archetypes.AudioEvent"),
            ArchetypeReflection {
                display_name: "Audio event",
                deprecation_summary: None,
                scope: None,
                view_types: &["AudioView"],
                fields: vec![
                    ArchetypeFieldReflection {
                        ...
                        component_type: "rerun.components.AudioTimestamp".into(),
                        docstring_md: "Media-time timestamp of each event, in nanoseconds.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "kind",
                        display_name: "Kind",
                        component_type: "rerun.components.AudioEventKind".into(),
                        docstring_md: "Semantic class of each event.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "labels",
                        display_name: "Labels",
                        component_type: "rerun.components.Text".into(),
                        docstring_md: "Human-readable event label.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "source_id",
                        display_name: "Source id",
                        component_type: "rerun.components.AudioSourceId".into(),
                        docstring_md: "Stable identity of the audio source these events refer to.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "audio_reference",
                    ...
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Related",
                        component_type: "rerun.components.EntityPath".into(),
                        docstring_md: "Optional related entities, such as the span or model response that emitted the event.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "payload",
                        ...
                        component_type: "rerun.components.KeyValuePairs".into(),
                        docstring_md: "Additional event metadata shared by this row.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "colors",
                        display_name: "Colors",
                        component_type: "rerun.components.Color".into(),
                        docstring_md: "Optional display color per event.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                ],
            },
            ...
            ArchetypeReflection {
                ...
                fields: vec![
                    ArchetypeFieldReflection {
                        ...
                        component_type: "rerun.components.AudioTimestamp".into(),
                        docstring_md: "The media-time position inside the referenced audio asset.\n\nTimestamps are nanoseconds relative to the start of the asset.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "audio_reference",
                        display_name: "Audio reference",
                        component_type: "rerun.components.EntityPath".into(),
                        docstring_md: "Optional reference to the entity that carries the [`archetypes.AssetAudio`](https://rerun.io/docs/reference/types/archetypes/asset_audio?speculative-link).\n\nIf omitted, the asset is assumed to be on the same entity.\nBlueprint overrides on the referenced asset are ignored — this is\nalways resolved against the data store.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                ],
            },
        ...
        (
            ArchetypeName::new("rerun.archetypes.AudioSeekIndex"),
            ArchetypeReflection {
                display_name: "Audio seek index",
                deprecation_summary: None,
                scope: None,
                view_types: &["AudioView"],
                fields: vec![
                    ArchetypeFieldReflection {
                        name: "media_time",
                        display_name: "Media time",
                        component_type: "rerun.components.AudioTimestamp".into(),
                        docstring_md: "Media time that this index entry accelerates.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "decode_time",
                        ...
                        component_type: "rerun.components.AudioTimestamp".into(),
                        docstring_md: "Nearest preceding decoder reset / key / seekable boundary.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "trim_samples",
                        display_name: "Trim samples",
                        component_type: "rerun.components.AudioDurationSamples".into(),
                        docstring_md: "Number of samples per channel to discard after decoding from `decode_time`.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "sequence_number",
                        display_name: "Sequence number",
                        component_type: "rerun.components.AudioSequenceNumber".into(),
                        docstring_md: "Sequence number of the segment containing `decode_time`, if known.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "discontinuity",
                        display_name: "Discontinuity",
                        component_type: "rerun.components.AudioDiscontinuity".into(),
                        docstring_md: "Whether the entry crosses or starts at a discontinuity.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "source_id",
                        display_name: "Source id",
                        component_type: "rerun.components.AudioSourceId".into(),
                        docstring_md: "Stable identity of the audio source this index was derived from.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "audio_reference",
                    ...
                    ArchetypeFieldReflection {
                        ...
                        component_type: "rerun.components.AudioStreamId".into(),
                        docstring_md: "Continuity stream id associated with this index batch.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                ],
            },
            ...
            ArchetypeReflection {
                ...
                fields: vec![
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Codec",
                        component_type: "rerun.components.AudioCodec".into(),
                        docstring_md: "The codec used to encode chunks.",
                        flags: ArchetypeFieldFlags::REQUIRED,
                    },
                    ArchetypeFieldReflection {
                        name: "sample_rate",
                        display_name: "Sample rate",
                        component_type: "rerun.components.AudioSampleRate".into(),
                        docstring_md: "Sample rate reported by / requested of the decoder, in Hz.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "channel_count",
                    ...
                    ArchetypeFieldReflection {
                        name: "priming_delay",
                        display_name: "Priming delay",
                        component_type: "rerun.components.AudioPrimingDelay".into(),
                        docstring_md: "Encoder pre-roll, in samples. Discarded by the decoder at stream start.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "stream_id",
                    ...
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Sequence number",
                        component_type: "rerun.components.AudioSequenceNumber".into(),
                        docstring_md: "Monotonic per-stream sequence number. Gaps surface as a diagnostic.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "discontinuity",
                        display_name: "Discontinuity",
                        component_type: "rerun.components.AudioDiscontinuity".into(),
                        docstring_md: "If true, the decoder is reset before this chunk is processed.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "seekable",
                        display_name: "Seekable",
                        component_type: "rerun.components.AudioSeekable".into(),
                        docstring_md: "If true, this chunk is an independent seek target.\n\nDefaults to `true` for Opus; codecs with inter-frame dependencies may\nset it false on non-key segments.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "source_id",
        ...
        (
            ArchetypeName::new("rerun.archetypes.AudioWaveformSummary"),
            ArchetypeReflection {
                display_name: "Audio waveform summary",
                deprecation_summary: None,
                scope: None,
                view_types: &["AudioView"],
                fields: vec![
                    ArchetypeFieldReflection {
                        name: "bucket_start",
                        display_name: "Bucket start",
                        component_type: "rerun.components.AudioTimestamp".into(),
                        docstring_md: "Media-time start of each summary bucket, in nanoseconds.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "bucket_duration_samples",
                        display_name: "Bucket duration samples",
                        component_type: "rerun.components.AudioDurationSamples".into(),
                        docstring_md: "Duration of each summary bucket, in samples per channel.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "min_amplitude",
                        display_name: "Min amplitude",
                        component_type: "rerun.components.Scalar".into(),
                        docstring_md: "Minimum normalized amplitude in each bucket.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "max_amplitude",
                        display_name: "Max amplitude",
                        component_type: "rerun.components.Scalar".into(),
                        docstring_md: "Maximum normalized amplitude in each bucket.",
                        flags: ArchetypeFieldFlags::REQUIRED | ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "rms_amplitude",
                        ...
                        component_type: "rerun.components.Scalar".into(),
                        docstring_md: "Optional RMS or loudness-like summary for each bucket.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "activity",
                        ...
                        component_type: "rerun.components.Scalar".into(),
                        docstring_md: "Optional activity/silence score for each bucket. Convention: 0 is silent, 1 is active.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "source_id",
                        display_name: "Source id",
                        component_type: "rerun.components.AudioSourceId".into(),
                        docstring_md: "Stable identity of the audio source this summary was derived from.",
                        flags: ArchetypeFieldFlags::UI_EDITABLE,
                    },
                    ArchetypeFieldReflection {
                        name: "audio_reference",
