...
* [`AudioAnnotationKind`](components/audio_annotation_kind.md): Semantic class of an audio-aligned time span.
...
* [`AudioEventKind`](components/audio_event_kind.md): Semantic class of an audio-aligned point event.
...
* [`AudioSourceId`](components/audio_source_id.md): Stable identity for an audio source across streams, assets, summaries, and annotations.
